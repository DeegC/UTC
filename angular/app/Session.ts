...
export class Session_Session extends zeidon.EntityInstance {
    ...
    get Configuration(): zeidon.EntityArray<Session_Configuration> {
        let entities = this.getChildEntityArray("Configuration")
        return entities as zeidon.EntityArray<Session_Configuration>;
    }

    get Instant(): zeidon.EntityArray<Session_Instant> {
        let entities = this.getChildEntityArray("Instant")
        return entities as zeidon.EntityArray<Session_Instant>;
    }
}
