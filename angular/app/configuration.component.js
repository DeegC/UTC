        ...
        this.form = new forms_1.FormGroup({
            ...
            ThermometerConfig: new forms_1.FormArray([
                new forms_1.FormGroup({
                    Name: new forms_1.FormControl(this.configOi.Configuration$.ThermometerConfig[0].Name),
                }),
                new forms_1.FormGroup({
                    Name: new forms_1.FormControl(this.configOi.Configuration$.ThermometerConfig[1].Name),
                }),
            ]),
        });
        console.log("nOnInit");
