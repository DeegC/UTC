 ...
 *
 * Creates a separate thread which reads the given PIDSource and takes care of the integral calculations, as well as
 * writing the given PIDOutput
 */
public class PIDController
{
     ...
     * implementations of this class such as PercentageTolerance and AbsoluteTolerance specify types of tolerance
     ...
     * @param period
     *            the loop time for doing calculations. This particularly effects calculations of the integral and
    ...
    /**
     * Read the input, calculate the output accordingly, and write to the output. This should only be called by the
     * PIDTask and is created during initialization.
     */
     ...
     *
     * @param minimumInput
     *            the minimum percentage expected from the input
     * @param maximumInput
     *            the maximum percentage expected from the output
     */
